...
<head>
    ...
    <title>Exercício ADO 03</title>
</head>
<body>
<!-- Faça um script em PHP que leia três números inteiros e mostre eles na ordem crescente. Três números em ordem crescente. -->
    <div class="image">
    ...
    <?php
        if (isset($_POST["numero1"]) && isset($_POST["numero2"]) && isset($_POST["numero3"]) && ($_POST["numero1"]!= "") && ($_POST["numero2"] != "") && ($_POST["numero3"] != "")) { 
            ...
            echo "<div id=\"resposta\"> Números inseridos na ordem digitada: $numero1, $numero2, $numero3 </div>"; 
            echo"<br>";
            echo "<div id=\"resposta\"> Números inseridos na ordem Crescente: " .implode(", ", $ordenados) . "</div>";
        } else {
